...
const { getProfile, updateProfile, demoVerify } = require('../controllers/profile.controller');
...
// Demo only; see demoVerify. Not behind roleGuard, which rejects the very
// unverified clinicians this is for.
router.post('/demo-verify', demoVerify);
