...
const required = ['SUPABASE_URL', 'SUPABASE_SERVICE_ROLE_KEY', 'CLIENT_APP_URL'];
...
module.exports = {
  ...
  clientAppUrl: process.env.CLIENT_APP_URL || 'http://localhost:3000', // used to build invite links + CORS origin
  smtp: {
